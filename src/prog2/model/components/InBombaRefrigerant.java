...
public interface InBombaRefrigerant {
     ...
     * prog2.model.VariableUniforme per determinar si la bomba es queda fora de servei. En
     * cas afirmatiu, s'haurà de registrar la situació dins d'una pàgina 
     * d'incidències.
     * @param p Objecte de tipus prog2.model.bitacola.PaginaIncidencies per a registrar si la bomba
